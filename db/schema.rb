...
ActiveRecord::Schema.define(version: 20170602190734) do
  ...
  create_table "user_zip_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_user_zip_codes_on_user_id"
    t.index ["zip_code_id"], name: "index_user_zip_codes_on_zip_code_id"
  end
